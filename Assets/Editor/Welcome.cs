...
public class Welcome : EditorWindow 
{
	...
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/XtremNoBrakesAssetStore/Documentation/_XtremNoBrakes%20documentation.pdf";
	private const string RATEUS_URL = "http://u3d.as/mFP";

	private const string NAME_OF_THE_GAME = "XTREM NO BRAKES";
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
